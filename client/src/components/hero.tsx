    ...
    <section id="hero" className="pt-20 pb-16 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          >
            I'm a senior Computer Science student at Colgate University, graduating in May 2026. With hands-on experience at Y Combinator and Silicon Valley startups, I bring professional expertise in software development, agile methodologies, and thriving in fast-paced environments. My passion for coding began at 13 with QBASIC and HTML, driven by a love for real-world problem-solving. I specialize in crafting clear, impactful solutions and value concise communication in everything I build.
          </motion.p>
